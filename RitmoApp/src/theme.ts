...
const DEFS: Record<ThemeId, Def> = {
  ...
  noir: { bg:"#050608", bg2:"#0E0F13", card:"rgba(44,46,52,0.45)", card2:"rgba(66,70,78,0.55)", line:"#363940", ink:"#F7F8FA", muted:"#A2A7AF", faint:"#6E727A", accent:"#8FB3D9", teal:"#8FB3D9", navy:"#4A5566", pink:"#D68FA5", coral:"#D9A487", good:"#9FC0A2", gold:"#D9C98F", blue:"#7FA8D0", gA:"#5A6270", gB:"#8FB3D9", goldL:"#E4D6A8", goldD:"#B8A876", nightA:"#1A1C20", nightB:"#0E0F12" },
};
