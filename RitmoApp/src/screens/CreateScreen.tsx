...
const styles = StyleSheet.create({
  ...
  levelSub: { color: colors.muted, fontSize: font.tiny, marginTop: 2 },
  ...
  topicTile: { width: "100%", aspectRatio: 1, borderRadius: radius.md, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line },
