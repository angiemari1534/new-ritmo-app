...
const sheet = StyleSheet.create({
  ...
  opt: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "rgba(3,5,10,0.35)", borderRadius: radius.md, borderWidth: 1, borderColor: "rgba(34,184,176,0.25)", padding: 15, marginBottom: 8 },
