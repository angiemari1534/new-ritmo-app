...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: colors.card, borderRadius: radius.md, borderWidth: 1, borderColor: colors.line, padding: 10, marginBottom: 10 },
  ...
  lvlPill: { alignSelf: "flex-start", marginTop: 5, backgroundColor: colors.card2, borderWidth: 1, borderColor: colors.accent, borderRadius: radius.pill, paddingVertical: 2, paddingHorizontal: 9 },
  ...
  iconBtn: { width: 34, height: 34, borderRadius: 17, alignItems: "center", justifyContent: "center", backgroundColor: colors.card2, borderWidth: 1, borderColor: colors.line, marginLeft: 4 },
  iconBtnFav: { borderColor: "#F05A96", backgroundColor: "rgba(240,90,150,0.15)" },
  iconPlus: { color: colors.ink, fontSize: 18, fontWeight: "900" },
  iconHeart: { color: colors.muted, fontSize: 16 },
  iconHeartOn: { color: "#F05A96" },
  iconDots: { color: colors.muted, fontSize: 18, fontWeight: "900" },
  ...
  flagRow: { flexDirection: "row", gap: 5, marginTop: 6 },
  flagBtn: { borderRadius: radius.pill, paddingVertical: 4, paddingHorizontal: 6, alignItems: "center", backgroundColor: "rgba(7,11,19,0.5)", borderWidth: 1, borderColor: "rgba(255,255,255,0.16)" },
  flagBtnText: { color: colors.muted, fontSize: 10, fontWeight: "800" },
