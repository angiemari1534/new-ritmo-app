...
const pl = StyleSheet.create({
  ...
  playAllText: { color: "#fff", fontWeight: "900", fontSize: font.body },
...
const guide = StyleSheet.create({
  ...
  stepTitle: { color: "#fff", fontSize: font.body, fontWeight: "900" },
  ...
  numText: { color: "#fff", fontSize: font.small, fontWeight: "900" },
...
const styles = StyleSheet.create({
  ...
  dualPlayTeal: { width: 34, height: 34, borderRadius: 17, backgroundColor: "#34D399", alignItems: "center", justifyContent: "center", shadowColor: "#34D399", shadowOpacity: 0.8, shadowRadius: 8, shadowOffset: { width: 0, height: 0 } },
  ...
  dualTitle: { color: "#fff", fontSize: font.body, fontWeight: "900", marginTop: 2 },
  ...
  welcomeTitle: { color: "#fff", fontSize: font.h2, fontWeight: "900" },
  ...
  createPillText: { color: "#fff", fontWeight: "900", fontSize: font.small },
  ...
  wideEmoji: { fontSize: 24, color: "#fff" },
  wideTitle: { color: "#fff", fontSize: font.body, fontWeight: "900" },
  ...
  memoryTitle: { color: "#fff", fontSize: font.h3, fontWeight: "900" },
