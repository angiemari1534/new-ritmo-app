...
const P = {
  ...
  Rock: [["Nirvana","Smells Like Teen Spirit","m"],["Red Hot Chili Peppers","Californication","m"],["The Doors","Light My Fire","m"],["Pink Floyd","Another Brick in the Wall","m"],["Candlebox","Far Behind","m"],["Nirvana","Come as You Are","m"],["Red Hot Chili Peppers","Can't Stop","m"],["The Doors","Riders on the Storm","m"],["Heart","Barracuda","f"],["Janis Joplin","Piece of My Heart","f"]],
